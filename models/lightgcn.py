...
class LightGCN(nn.Module):
    def __init__(self, sparse_graph, user_num, item_num):
    ...
    def computer(self):
        ...
        g_droped = g_droped.to(users_emb.device)
    ...
    def get_embedding_dim(self):
        return self.embedding_user.weight.shape[1]
